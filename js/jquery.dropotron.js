...
(function(jQuery) {
	...
	jQuery.dropotron = function(options) {
		...
		_menus.each(function() {
			...
			menu.disableSelection_dropotron().hide().addClass(settings.menuClass).css('position', 'absolute').mouseenter(function(e) {
				window.clearTimeout(hideTimeoutId);
			...
			opener.disableSelection_dropotron().addClass('opener').css('cursor', 'pointer').bind(_eventType, function(e) {
